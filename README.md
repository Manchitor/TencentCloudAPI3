...
[[TencentCloudAPI3 TC] setConfig:@{
 ...
 NSDictionary *getTokenParams = @{
   ...
   @"data": @{ // data里面是真正的数据
     @"Bid": @"value", //此参数根据具体服务官网替换 Bid 和 value
     @"Scene": @"value" //此参数根据具体服务官网替换 Scene 和 value
   }
 };
   
// 3、获取token示例
[[TencentCloudAPI3 standard] getResult:getTokenParams success:^(NSDictionary *responseObject){
